    ...
    pages: {
      ...
      admin: {
        ...
        schedule: {
          ...
          teacherMapUnmapped: string;
          teacherMapNameColumn: string;
          teacherMapAccountColumn: string;
          teacherMapSlotsColumn: string;
          teacherMapPlaceholder: string;
          teacherMapSave: string;
          teacherMapSaving: string;
          teacherMapSaved: string;
          teacherMapSuggestion: string;
          teacherMapError: string;
          tableEmpty: string;
          dayColumn: string;
          startColumn: string;
          endColumn: string;
