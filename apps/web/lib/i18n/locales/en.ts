      ...
      admin: {
        ...
        users: {
          ...
          pending: {
            ...
            hint: 'Signed in via Google/Microsoft with an email matching your school domain — pick a role and approve.',
            empty: 'No accounts awaiting approval right now.',
            approve: 'Approve',
            approving: 'Approving…',
            approveError: 'Could not approve the account.',
            approveErrorStale: 'The account was already handled or no longer matches your school domain. The list was refreshed.',
          },
          invite: {
            heading: 'Invite a user',
            subtitle: 'Sends an email with a one-time account-creation link.',
            nameLabel: 'Name',
            emailLabel: 'Email',
            roleLabel: 'Role',
            submit: 'Send invite',
            submitting: 'Sending…',
            success: 'Invite sent.',
            errorDuplicate: 'That email already has an unclaimed invite.',
            errorInvalid: 'Check the name, email and role.',
            errorGeneric: 'Could not send the invite.',
          },
          bulkInvite: {
            heading: 'Invite in bulk via CSV',
            hint: 'Headers: email, name, role (student/teacher/admin) — one row per person.',
            uploadLabel: 'Choose CSV file',
            submit: 'Upload',
            submitting: 'Uploading…',
            resultSummary: '{invited} invited, {alreadyInvited} already had an invite.',
            resultFailed: '{failed} rows could not be invited.',
            errorInvalid: 'The CSV is malformed. Check the header row and contents.',
            errorGeneric: 'Something went wrong during upload.',
          },
        },
        schools: {
          ...
          identityDomainLabel: 'SSO domain (optional)',
          identityDomainHint: 'Only set for schools running Google Workspace or Microsoft 365 — matched against signing-in users’ email domain.',
