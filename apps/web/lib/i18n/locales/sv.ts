    ...
    pages: {
      ...
      admin: {
        ...
        users: {
          ...
          pending: {
            heading: 'Väntar godkännande',
            hint: 'Loggat in via Google/Microsoft med en e-post som matchar din skolas domän — välj roll och godkänn.',
            empty: 'Inga väntande konton just nu.',
            approve: 'Godkänn',
            approving: 'Godkänner…',
            approveError: 'Kunde inte godkänna kontot.',
            approveErrorStale: 'Kontot har redan hanterats eller matchar inte längre din skolas domän. Listan uppdaterades.',
          },
          invite: {
            heading: 'Bjud in användare',
            subtitle: 'Skickar ett mejl med en engångslänk för att skapa konto.',
            nameLabel: 'Namn',
            emailLabel: 'E-post',
            roleLabel: 'Roll',
            ...
            errorDuplicate: 'E-posten har redan en oanvänd inbjudan.',
            errorInvalid: 'Kontrollera namn, e-post och roll.',
            errorGeneric: 'Kunde inte skicka inbjudan.',
          },
          bulkInvite: {
            heading: 'Bjud in flera via CSV',
            hint: 'Rubriker: email, name, role (student/teacher/admin) — en rad per person.',
            uploadLabel: 'Välj CSV-fil',
            submit: 'Ladda upp',
            submitting: 'Laddar upp…',
            resultSummary: '{invited} inbjudna, {alreadyInvited} hade redan en inbjudan.',
            resultFailed: '{failed} rader kunde inte bjudas in.',
            errorInvalid: 'CSV-filen är felformaterad. Kolla rubrikraden och innehållet.',
            errorGeneric: 'Något gick fel vid uppladdning.',
          },
        },
        schools: {
          ...
          identityDomainLabel: 'SSO-domän (frivilligt)',
          identityDomainHint: 'Sätts bara för skolor som kör Google Workspace eller Microsoft 365 — matchas mot inloggande användares e-postdomän.',
          identityDomainBadge: 'SSO',
          createSubmit: 'Skapa',
          creating: 'Skapar…',
