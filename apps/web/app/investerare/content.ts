    ...
    cols: [
      {
        ...
        rows: [
          ...
          {
            sv: 'Repeterar med AI-genererade övningsprov, i egen takt.',
            en: 'Reviews with AI-generated practice tests, at their own pace.',
          },
        ],
      },
      {
        ...
        rows: [
          ...
          {
            sv: 'Följer förståelsen per begrepp — och hur elevernas övningsprov går.',
            en: 'Tracks understanding per concept — and how students’ practice tests go.',
          },
        ],
      },
    ],
