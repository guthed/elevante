...
-- 20260807084220) men saknade lokal fil — upptäckt under
-- school-provisioning-grenens slutgranskning 2026-08-12, eftersom den
-- byter ut samma handle_new_auth_user() som den grenen också ändrar.
